...
- `start_new_game.yaml`: clears app state, captures the Sector 9 title plate, shared bottom cinematic narration card, and unknown-speaker dialogue, then verifies the buzzer-backed transition opens exploration in Nova's Bunk.
