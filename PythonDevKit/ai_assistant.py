...
class _SimpleContextIndex:
    ...
    def __init__(self, root: Path):
        ...
        self._nodes  = _read_any("hub_nodes.json", [])
...
class RoomClusterPage(_BuildPageBase):
    ...
    def get_proposals(self) -> Dict[str, Any]:
        ...
        nodes_path = self.root / "hub_nodes.json"
        ...
        if use_ai and not allowed and not self.enable_for_node.isChecked():
            QMessageBox.information(
                ...
                "Check 'Enable AI room autogen for this node' to proceed, or enable it later in hub_nodes.json."
            )
            return {}
        ...
        if self.enable_for_node.isChecked() and not allowed:
            ...
            # This updated hub_nodes.json will be included in our proposals below.
        ...
        return {"rooms.json": merged_rooms, "hub_nodes.json": cur_nodes}
