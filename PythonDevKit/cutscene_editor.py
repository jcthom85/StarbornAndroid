...
from data_core import detect_assets_dir, json_load, json_save, unique_id
from ui_common import attach_hotkeys, attach_list_context_menu, flash_status
from cutscene_editor_commands import ChangeValueCmd, AddStepCmd, DeleteStepCmd, MoveStepCmd
...
class CutsceneEditor(QWidget):
    ...
    def __init__(self, project_root: Optional[Path]=None):
        ...
        self.root = detect_assets_dir(project_root)
