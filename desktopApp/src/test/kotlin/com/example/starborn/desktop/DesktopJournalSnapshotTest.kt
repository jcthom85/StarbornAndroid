...
class DesktopJournalSnapshotTest {

    @get:Rule
    val composeTestRule = createComposeRule()

    @Test
    fun captureJournalTabSnapshot() {
        val tempSaveDir = File(System.getProperty("java.io.tmpdir"), "starborn_journal_snap_${System.currentTimeMillis()}")
        tempSaveDir.mkdirs()
        ...
        try {
            ...
            composeTestRule.setContent {
                DesktopFieldMenuContent(
                    services = services,
                    initialTab = DesktopMenuTab.JOURNAL,
            ...
            ImageIO.write(awtImage, "png", File(artifactsDir, "desktop_journal_tab.png"))
