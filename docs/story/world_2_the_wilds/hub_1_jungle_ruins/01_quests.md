...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **MQ_06** | **Impact** | Survive the crash site. | 1. Wake up in wreckage.<br>2. Recover the Chime from the pod core.<br>3. Find Zeke (injured).<br>4. Defend site from "Razor-Vines". | Medkit | **Tutorial:** Survival mechanics (Healing). Zeke is useless here, establishing Nova's need to step up. |
| **MQ_07** | **The Signal** | Track the distress beacon. | 1. Follow the pulse through the Razor-Vine Path.<br>2. Slot the Chime into the "Source Lock" on the Temple Gate.<br>3. Enter the **Sanctuary**. | **Source Art: Link** | Puzzle: The lock hums in harmony with the Chime. |
